...
router.get('/', function (req, res) {
 res.render('index', { title: 'TastyFood App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'TastyFood App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'TastyFood App Login', user : req.user });
 });
